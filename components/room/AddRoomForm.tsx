...
const formSchema = z.object({
  ...
  description: z
    .string()
    .min(3, { message: "Description must be atleast 3 chars long" }),
  bed_count: z.coerce.number().min(1, { message: "Bed count is required" }),
  geust_count: z.coerce.number().min(1, { message: "Geust count is required" }),
  ...
  room_price: z.coerce.number().min(1, { message: "Room price is required" }),
...
const AddRoomForm = ({ hotel, room, handleDialougeOpen }: AddRoomFormProps) => {
    ...
    if (hotel && room) {
      ...
      axios
        ...
        .then((res) => {
          toast({
            title: "Room created!",
            description: "Your room is successfully added.",
          });
          router.refresh();
          setISLoading(false);
        })
    ...
    <div className="max-h-[75vh] overflow-y-auto p-2">
      <Form {...form}>
        <form className="space-y-5">
          ...
          <div>
            <FormLabel>Choose room facilites</FormLabel>
            <FormDescription>
              What facilites make this room good?
            </FormDescription>
          ...
          <div className="flex gap-5 ">
            <div className="flex-1 flex-col gap-5">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormDescription>
                      How many beds are availabel in this room?
                    </FormDescription>
                    <FormControl>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Geust count</FormLabel>
                    <FormDescription>
                      How many geust are allowed in this room?
                    </FormDescription>
                    <FormControl>
            ...
            <div className="flex-1 flex-col gap-5">Right Side</div>
            <div></div>
          </div>
