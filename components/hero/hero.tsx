...
export const Hero = () => {
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden mb-20">
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center p-4">
        ...
        >
          <h1 className="font-bold font-display text-xl text-white drop-shadow-lg md:text-2xl lg:text-3xl">
            Rencanakan, Jelajahi, Bagikan.
          </h1>
