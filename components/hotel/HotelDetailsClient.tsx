  ...
  return (
    <div className="flex flex-col gap-5 pb-2">
        ...
        <div className=" font-semibold mt-4">
          <span className="flex items-center gap-2">
            ...
            <span>
              {state?.name}
              {state?.name && ", "}
              {hotel.city} {hotel.city && ", "} {country?.name}
            </span>
          </span>
        </div>
        <h3 className="font-semibold text-lg mt-5 mb-2">Location Details</h3>
        <p className="text-primary/90 mb-2">{hotel.locationDescription}</p>
        <h3 className="font-semibold text-lg mt-5 mb-2">About this hotel</h3>
        <p className="text-primary/90 mb-2">{hotel.description}</p>
        <h3 className="font-semibold text-lg mt-5 mb-2">Popular Facilities</h3>
      ...
      <div>
        {!!hotel.rooms.length && (
          <div>
            <h3 className="font-semibold text-lg mt-5 mb-2">Hotel Rooms</h3>
